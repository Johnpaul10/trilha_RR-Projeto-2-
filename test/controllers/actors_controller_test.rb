...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { birthyear: @actor.birthyear, email: @actor.email, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthyear: @actor.birthyear, email: @actor.email, name: @actor.name } }
