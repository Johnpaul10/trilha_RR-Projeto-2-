...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { release_year: @filme.release_year, title: @filme.title } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { release_year: @filme.release_year, title: @filme.title } }
